    ...
    return {
        question: function(question) {
            ...
            if(question == "solveQuadratic") {
                ...
                let aValueIsOneWorking = `${_quadratic}<br>
                (1) Find the two numbers which add to equal the coefficient of x and multiply to equal the constant. These are ${_factor1} and ${_factor2}<br>
                ...
                const AC = quadratic.a * quadratic.c;
                stepsOfWorking = quadratic.a == 1 ? `${_quadratic}<br>
                (1) Find the two numbers which add to equal the coefficient of x and the constant. These are ${_factor1} and ${_factor2}<br>
                (2) Put each number in a set of brackets with x, ${format.wrapLatex("(x" + format.evaluatePlus(_factor1) + ")(x" + format.evaluatePlus(_factor2) + ")")}<br>
